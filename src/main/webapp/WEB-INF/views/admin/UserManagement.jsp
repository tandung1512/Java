...
<form action="/admin/SearchUserManagement" method="post" class="search-form">
    <input name="keywords" value="${kw}" class="search-input">
...
<table class="align-middle mb-0 table table-borderless table-striped table-hover">
    ...
    <tbody>
        <c:forEach var="account" items="${accitems}">
            <tr>
                ...
                <td>${account.email}</td>
                <td>
                    <a href="/admin/UserManagement/edit/${account.username}">Edit</a>
