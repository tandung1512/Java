...
<body>
								...
								<div class="table-responsive">
									<%-- <form action="ProductManagement/create" method="get">
										<input type="text" name="name" placeholder="Product Name"
											...
											placeholder="Image URL"> <input type="number"
											name="price" placeholder="Price" required> <input
											type="submit" value="Add Product">
									</form> --%>
									<jsp:include page="formProductManagement.jsp" />
    ...
    <c:forEach var="product" items="${items}">
        <tr>
            ...
            <td>
                <a href="/admin/ProductManagement/edit/${product.product_Id}">Edit</a>
                <a href="/admin/ProductManagement/delete/${product.product_Id}">Delete</a>
            </td>
        </tr>
    </c:forEach>
</table>
