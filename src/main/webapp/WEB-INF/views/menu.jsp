...
<nav
	...
	arial-label="Furni navigation bar" style="background-color: white;">
	<div class="container">
		<a class="navbar-brand" href="/index" style="width: 30%"> <img
			src="/images/logo-menu.png" style="width: 30%; margin-left: 0px;"
		...
		<div class="collapse navbar-collapse" id="navbarsFurni">
			...
			<ul class="custom-navbar-cta navbar-nav mb-2 mb-md-0 ms-5">
				...
				<li><a class="nav-link" href="/cart"><img
						src="/images/cart.svg"></a></li>
				<c:if test="${sessionScope.loggedIn == true}">
					<li><a class="nav-link" href="/logout"><s:message
								code="menu.dx" /></a></li>
				</c:if>
			...
			<div class="dropdown ms-3">
				...
				<ul class="dropdown-menu dropdown-menu-end"
					...
					<li><a class="dropdown-item" href="?lang=vi"><s:message
								code="menu.vi" /></a></li>
					<li><a class="dropdown-item" href="?lang=ko"><s:message
								code="menu.ko" /></a></li>
				</ul>
			</div>
		</div>
